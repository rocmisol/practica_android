...
public class FuncionRelleno {
    ...
    static ArrayList<Evento> rellenaEventos() {
        ...
        String descripcionReinoHielo ="el 29 de noviembre al 5 de enero de 18’30 a 22’00 horas\n" +
        ...
        String descripcionAnimales = "La obra transcurre en una misma noche, durante la cena.\n" +
                ...
                " hace tiempo y se reúnen para celebrar una cena de bienvenida. Director: Fele Martínez.. Autora: Estel Solé.\n" +
